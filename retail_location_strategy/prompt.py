...
2. Check if the `TARGET_LOCATION` (Geographic area to analyze (e.g., "Worcester, MA")) and `BUSINESS_TYPE` (Type of business (e.g., "coffee shop", "bakery", "gym")) have been provided.
